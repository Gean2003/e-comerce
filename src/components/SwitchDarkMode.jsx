...
const spring = {
  ...
  damping: 30
	...
	<div onClick={toggleSwitch} className={ `mx-3 w-[80px] h-[30px]  lg:w-[100px] lg:h-[30px] rgba flex justify-start rounded-[50px]  items-center py-[10px] px-[10px] ${isOn != true ? 'justify-start' : 'justify-end'}` }>
